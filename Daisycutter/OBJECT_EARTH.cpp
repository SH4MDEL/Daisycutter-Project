...
objRead OBJECT_EARTH::objReader;
GLint OBJECT_EARTH::object = objReader.loadObj_normalize_center("sphere.obj");

OBJECT_EARTH::OBJECT_EARTH()
{
	OnCreate();
}
...
void OBJECT_EARTH::OnCreate()
{

}

void OBJECT_EARTH::initBuffer(GLint s_program)
{
...
void OBJECT_EARTH::Render()
{
	glUniform3f(objColorLocation, 0.1f, 1.0f, 0.1f);
	glBindVertexArray(vao[0]);
	glDrawArrays(GL_TRIANGLES, 0, object);
}

void OBJECT_EARTH::Update(float fTimeElapsed)
{

}

void OBJECT_EARTH::putFactor(glm::mat4 inputFactor)
{
...
glm::mat4 OBJECT_EARTH::getFactor()
{
	return myFactor;
}
